...
namespace LotusRMSweb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                user.Update(Input.FirstName, Input.MiddleName, Input.LastName, Input.Contact);
        ...
        private RMSUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<RMSUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(RMSUser)}'. " +
                    $"Ensure that '{nameof(RMSUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +

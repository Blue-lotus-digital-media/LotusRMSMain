...
function toggleMe(me) {
    ...
    $.ajax({
        type: 'GET',
        url: "/admin/Menutype/statuschange",
        data: "id=" + id,
            ...
            },
            {
                ...
                render: function (data) {
                    return `<div class="text-center">
                              <a href="/Admin/MenuType/Update/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>    
                              </a>
                              <a href="/Admin/MenuType/Delete/${data}" class="btn btn-danger text-white" style="cursor:pointer">

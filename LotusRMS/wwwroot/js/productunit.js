...
function toggleMe(me) {
    ...
    $.ajax({
        type: 'GET',
        url: "/admin/productunit/statuschange",
        data: "id=" + id,
            ...
            },
            {
                ...
                render: function (data) {
                    return `<div class="text-center">
                              <a href="/Admin/productunit/UpCreate/${data}" class="btn btn-success text-white" style="cursor:pointer">
                                <i class="bi bi-pencil-square"></i>    
                              </a>
                              <a href="/Admin/productunit/Delete/${data}" class="btn btn-danger text-white" style="cursor:pointer">
